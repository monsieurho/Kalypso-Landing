<template>
    <div class="terms-overall">
<h1>Terms and Conditions</h1>
<p>Last updated: November 12, 2021</p>
...
<ul>
    ...
    <li>
        <p><strong>Country</strong> refers to: Cayman Islands</p>
    </li>
    <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to Kalypso Network, Cayman Islands.</p>
    </li>
    <li>
    ...
    <li>
        <p><strong>Website</strong> refers to Kalypso Network, accessible from <a href="https://kalypso.network/"
                rel="external nofollow noopener" target="_blank">https://kalypso.network/</a></p>
    </li>
    <li>
...
<ul>
    <li>By email: hello@kalypso.network</li>
</ul>
    </div>
</template>
